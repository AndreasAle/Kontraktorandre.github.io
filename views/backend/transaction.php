        ...
        <div class="box-body table-responsive">
            <table id="tabel" class="table table-bordered table-striped table-hover">
                <thead class="bg-gray">
                    <tr>
                        <td width="20">NO</td>
                        <td id="edit" width="5"><i class="fa fa-edit"></i></td>
                        <td id ="barcode" width="5"><i class="fa fa-barcode"></i></td>
                        <td>KODE</td>
                        <td>NO RESI</td>
                        <td>WAKTU</td>
                        <td>PEMESAN</td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$n++.'.';?></td>
                        <td id="edit-value"><a href="#modal_add" data-toggle="modal" onclick="submit(<?=$t->idorder;?>)"><i
                                    class="fa fa-edit"></i></a>
                        </td>
                      
                        <td id="barcode-value"><a href="#modal_resi" data-toggle="modal" onclick="addresi(<?=$t->idorder;?>)"><i
