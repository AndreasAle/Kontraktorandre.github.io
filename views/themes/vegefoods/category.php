<div class="hero-wrap hero-bread"style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/12.png');">
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread text-dark">KATEGORI PRODUK KAMI</h1>
            </div>
        </div>
    </div>
</div>

<section class="ftco-section ftco-category ftco-no-pt mt-6 justify-content">
    <div class="container">
        ...
        <p>Beberapa pilihan kategori yang telah kami sediakan, silahkan cek beberapa perihal barang dibawah ini </p>
        <div class="row">
