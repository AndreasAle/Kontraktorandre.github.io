<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/traktor6.jpg');">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate" style="overflow:scroll; height:400px;">
                <?php foreach(produk_gambar(decrypt_url($produk->idproduct)) as $product_image):?>
                <a href="<?=base_url().'uploads/products/'.$produk->product_image;?>" class="image-popup">
                <img src="<?=base_url().'uploads/products/'.$produk->product_image;?>" class="img-fluid" alt="<?=$produk->product_image;?>"
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p class="text-center"><a href="#" class="buy-now btn btn-black py-3 px-5"
                        ...
                        <p class="text-center"><a href="<?=base_url('Welcome/product');?>" class="btn btn-black py-3 px-5">Back</a></p>
            </div>
        </div>
    </div>
