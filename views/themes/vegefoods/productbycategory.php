<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/12.png');">
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs text-dark"><span class="mr-2 text-dark"><a href="index.html">Beranda</a></span>&gt;
                    <span class="text-dark">Produk By Kategori</span>
                </p>
                <h1 class="mb-0 bread text-dark"><?=$kategori->category_name;?></h1>
            </div>
        </div>
    </div>
</div>
